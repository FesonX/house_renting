					...
					<div class="agent-grids">
						...
						<div class="col-md-12 agent-grid" style="padding-left:0;padding-right:0;">
							<div class="agent-right">
								<h4>基本信息</h4>
								<ul>
								<li><i class="glyphicon glyphicon-user" aria-hidden="true"></i> 用户id : ${landlord.lid}</li>
								<li><i class="glyphicon glyphicon-phone" aria-hidden="true"></i> 昵称 : ${landlord.name}</li>
								<li><i class="glyphicon glyphicon-heart" aria-hidden="true"></i> 性别 : ${landlord.gender}</li>
								<li><i class="glyphicon glyphicon-print" aria-hidden="true"></i> 姓名 : ${landlord.realname}</li>
							</ul>
							<a href="LandlordModify.jsp" class="button3 hvr-shutter-out-horizontal">修改信息</a>
							</div>
							<div class="agent-right">
								<h4>隐秘信息</h4>
								<ul>
								<li><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i> 区域: ${district.name}</li>
								<li>&nbsp;&nbsp;&nbsp;&nbsp; </li>
								
								<li><i class="glyphicon glyphicon-lock" aria-hidden="true"></i> 密码 : **********</li>
							</ul>
							<a href="LandlordPw.jsp" class="button3 hvr-shutter-out-horizontal" style="margin-top:3.32em;">修改密码</a>
							</div>
							<div class="clearfix"></div>
						</div>
					<div class="clearfix"></div>
