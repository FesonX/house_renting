...
<div class="container">
    <div class="col-md-6 col-md-offset-3">
        <form action="landlordRegister.do" class="" method="post" id="" onsubmit="return check()">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="input-group">
                    ...
                    <input id="lid" name="lid" class="form-control" placeholder="请输入手机号码" maxlength="11" type="text">
                </div>
