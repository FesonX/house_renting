				...
				<div class="container">
					...
					<form  action="renterModify.do" method="post" id="" onsubmit="return check()">
						<div class="col-md-12 agent-grid">
							<div class="agent-right" style="width:100%;">
								<h4>修改信息</h4>
								<ul>
								<li><i class="glyphicon glyphicon-user" aria-hidden="true"></i> 用户id: &nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="rid" class="form-control" placeholder="输入昵称..." style="display:inline;width:200px;"></li>
								<li><i class="glyphicon glyphicon-phone" aria-hidden="true"></i> 昵称 : &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name" class="form-control" placeholder="输入昵称..." style="display:inline;width:200px;"></li>
								<li><i class="glyphicon glyphicon-heart" aria-hidden="true"></i> 性别 : &nbsp;&nbsp;&nbsp;&nbsp;<select name="gender" class="form-control" style="display:inline;width:200px;">
																									  <option>男</option>
																									  <option>女</option>
																									</select></li>
								<li><i class="glyphicon glyphicon-print" aria-hidden="true"></i> 姓名 : &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="realname" class="form-control" placeholder="输入姓名..." style="display:inline;width:200px;"></li>
								<li><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i> QQ号 : &nbsp;&nbsp;<input type="text" name="qq" class="form-control" placeholder="输入QQ号..." style="display:inline;width:200px;"></li>
								<li><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i> 微信号 : <input type="text" name="wechat" class="form-control" placeholder="输入微信号..." style="display:inline;width:200px;"></li>
							</ul>
							<button type="submit" class="button3 hvr-shutter-out-horizontal">确认修改</button>
							</div>
							<div class="clearfix"></div>
						</div>
					<div class="clearfix"></div>
