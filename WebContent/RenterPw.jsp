		...
		<div class="content">
			<div class="agent-section">
				<div class="container">
					...
					<form  action="renterPw.do" method="post" id="" onsubmit="return check()">
						<div class="col-md-6 agent-grid">
							...
							<div class="agent-right">
								<h4>修改密码</h4>
								<ul>
								<li>原密码 : <input name="old_password" type="password" style="height:28px;width:142px;"></input></li>
								<li>新密码 : <input name="new_password" type="password" style="height:28px;width:142px;"></input></li>
								<li>确认密码 : <input name="rearly_password" type="password" style="height:28px;width:128px;"></input></li>
							</ul>
