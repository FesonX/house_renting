...
<div class="container">
	<div class="row-fluid">
		<div class="span12">
			<form action="renterRegister.do" method="post" id="" onsubmit="return check()">
				<fieldset>
					 <legend>欢迎注册</legend>
					  <label>账号</label>
					  ...
					  <label>确认密码</label>
					  <input type="password" placeholder="密码" name='repassword'><br>
					  <label>真实姓名</label>
					  ...
					  <label>电话号码</label>
					  <input type="text" name="rid" placeholder="电话"><br>
					  <label>QQ</label>
